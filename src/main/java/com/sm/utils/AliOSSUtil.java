...
public class AliOSSUtil {
    ...
    public static String ossUpload(File file) {
        String bucketDomain = "https://student-manage-whl.oss-cn-beijing.aliyuncs.com/";
        //Endpoint以北京为例，其它Region请按实际情况填写
        String endpoint = "http://oss-cn-beijing.aliyuncs.com";
        //accessKeyId和accessKeySecret，请填写自己的
        String accessKeyId = "LTAIJvy4abJHWzgl";
        String accessKeySecret = "BAQBgD4rQfRvwEmFCVENzNjn733oOF";
        //Bucket名称
        String bucketName = "student-manage-whl";
        //目录名称
        String filedir = "logo/";
        //获得本地文件的文件名
